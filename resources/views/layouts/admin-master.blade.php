...
<section id="container">
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <header class="header black-bg">
        ...
        <!--logo start-->
        <a href="index.html" class="logo"><b> {{htmlentities('<Cipher/> - Admin Section')}} </b></a>
        <!--logo end-->
        </div>
        <div class="top-menu">
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <p class="centered"><a href="profile.html"><img src="assets/img/ui-sam.jpg" class="img-circle"
                                                                width="60"></a></p>
                <h5 class="centered">Hey admin, {{Auth::guard('admins')->user()->name}}</h5>

                <div style="margin-top:40px">
                    <li>
                        <a {{Request::route()->getName()=='admin.home'? 'class=active':''  }} href="{{route('admin.home')}}">
                            <i class="fa fa-dashboard"></i>
                            <span>Home</span>
                        </a>
                    </li>
                    <li>
                        <a {{Request::route()->getName()=='admin.add'? 'class=active':''  }} href="{{route('admin.add')}}">
                            <i class="fa fa-dashboard"></i>
                            <span>Add Questions</span>
                        </a>
                    </li>
                    <li>
                        <a {{Request::route()->getName()=='admin.edit'? 'class=active' : '' }} href="{{route('admin.edit')}}">
                            <i class="fa fa-dashboard"></i>
                            <span>Edit Questions</span>
                        </a>
                    </li>
                    <li>
                        <a {{Request::route()->getName()=='admin.manageTeams'? 'class=active' : ''  }} href="{{route('admin.manageTeams')}}">
                            <i class="fa fa-dashboard"></i>
                            <span>Manage Teams</span>
                        </a>
                    </li>
                    <li>
                        <a {{Request::route()->getName()=='admin.addAdmin'? 'class=active' : ''  }} href="{{route('admin.addAdmin')}}">
                            <i class="fa fa-dashboard"></i>
                            <span>Add Admin</span>
                        </a>
                    </li>
                    <li>
                        <a {{Request::route()->getName()=='leaderboard'? 'class=active' : ''  }} href="{{route('admin.edit')}}">
                            <i class="fa fa-dashboard"></i>
        ...
        <section class="wrapper">
            ...
            <div class="row">
                ...
                *********************************************************************************************************************************************************** -->
                ...
                <div class="col-sm-3 ds notif-box">
                    <h3>NOTIFICATIONS</h3>
                    <?php
                        $notifications = \App\Notification::orderBy('created_at','desc')->take(10)->get();
                        ?>
                    ...
                    <div class="desc">
                        ...
                        <div class="details">
                            <p>
                                <muted>{{$notification->created_at->diffForHumans()}}</muted>
                                <br/>
                    ...
                    @foreach($admins as $admin)
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="assets/img/a.jpg" width="35px" height="35px"
                                     align="">
                            </div>
                            <div class="details">
                                <a href="#">{{$admin->name}}</a>
